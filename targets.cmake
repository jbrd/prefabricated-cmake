...
function(add_test_target TARGET SOURCES)
	...
	if(${VALGRIND})
		if(VALGRIND_PATH)
			...
			add_test(NAME ${TARGET}_memcheck COMMAND ${VALGRIND_PATH} ${MEMCHECK_ARGS} $<TARGET_FILE:${TARGET}>)
			set(DRD_ARGS "--tool=helgrind" "--error-exitcode=1")
			add_test(NAME ${TARGET}_helgrind COMMAND ${VALGRIND_PATH} ${DRD_ARGS} $<TARGET_FILE:${TARGET}>)
		endif()
	endif()
endfunction()
