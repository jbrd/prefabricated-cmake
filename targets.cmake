		...
		elseif(${VALUE} STREQUAL SYSTEM)
			...
			if (${ARRAY} EQUAL 0)
				...
				if (TARGET ${TARGET}_Static)
					target_link_libraries(${TARGET}_Static ${VALUE}${SUFFIX})
					if (TARGET ${VALUE}${SUFFIX})
						add_dependencies(${TARGET}_Static ${VALUE}${SUFFIX})
					endif()
				endif()
				if (TARGET ${TARGET}_Static_Tests)
					target_link_libraries(${TARGET}_Static_Tests ${VALUE}${SUFFIX})
					if (TARGET ${VALUE}${SUFFIX})
						add_dependencies(${TARGET}_Static_Tests ${VALUE}${SUFFIX})
					endif()
				endif()
			endif()
		endif()
