...
function(add_test_target TARGET SOURCES)
	...
	if(VALGRIND)
		...
		add_test(NAME ${TARGET}_memcheck COMMAND ${VALGRIND} ${MEMCHECK_ARGS} $<TARGET_FILE:${TARGET}>)
		set(DRD_ARGS "--tool=helgrind" "--error-exitcode=1")
		add_test(NAME ${TARGET}_helgrind COMMAND ${VALGRIND} ${DRD_ARGS} $<TARGET_FILE:${TARGET}>)
	endif()
...
function(gather_tests TARGET LABEL SOURCES)
	...
	if(NOT "${TEST_SOURCES}" STREQUAL "")
		add_test_target(${TARGET}_Tests ${TEST_SOURCES} ${SOURCES})
